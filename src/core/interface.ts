import {HTMLBrand, HTML} from '../template/interface'
...
export interface Render<P, D, C, M, K, A> extends Other<P, D, C, M, K, A> {
  ...
  render(f: (this: P&D&C&M&A&Vue, h: HTML<K>, vm: P&D&C&M&A&Vue) => HTMLBrand): Other<P, D, C, M, K, A>
}
...
export interface Other<P, D, C, M, K, A> {
